...
class Block {
    ...
    calculateHash() {
        return crypto
            .createHash('sha256')
            .update(this.index + this.previousHash + this.timestamp + JSON.stringify(this.data) + this.previousHash)
            .digest('hex');
    }
}
...
// Create a blockChain and add a blocks
...
// Tamper with a block to test immutability
